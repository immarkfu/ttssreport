...
CREATE TABLE IF NOT EXISTS s1_signal_results (
    ...
    -- 均线数据(白线)
    ma5 DECIMAL(15, 4) COMMENT 'MA5均线',
    ma10 DECIMAL(15, 4) COMMENT 'MA10均线',
    ma20 DECIMAL(15, 4) COMMENT 'MA20均线',
    ma30 DECIMAL(15, 4) COMMENT 'MA30均线',
    ma60 DECIMAL(15, 4) COMMENT 'MA60均线',
    ...
    -- 展示要素(多标签组合)
    display_factor TEXT COMMENT '展示要素(如: J>80, 跌破白线, 量比>2.0)',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='S1卖点信号加工数据表';
